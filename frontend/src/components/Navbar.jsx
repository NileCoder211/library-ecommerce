      ...
      <header className="fixed top-0 left-0 w-full h-16 z-50 bg-[#faf9f7]/95 backdrop-blur-md shadow-sm">
        <div className="container mx-auto px-4 h-full flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center gap-3">
            ...
            {/* Cart */}
            {user && (
              <Link to="/cart" className="relative flex items-center text-black hover:text-black/50 transition">
            ...
            {user ? (
              // ── Logged in: avatar replaces logout button ───────────────────
          ...
          <div className="absolute top-16 left-0 right-0 bg-white border-t border-gray-100 shadow-lg">
            <nav className="flex flex-col py-2">
              ...
              <div className="px-6 py-3">
                <p className="text-[10px] text-gray-400 uppercase tracking-widest mb-2">Collections</p>
