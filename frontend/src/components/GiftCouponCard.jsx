...
const GiftCouponCard = ({ coupon, setCoupon, isCouponApplied, setIsCouponApplied }) => {
  ...
  return (
    ...
    rounded-2xl    space-y-4  p-4 shadow-sm sm:p-6"
      ...
      <div className="space-y-4 ">
        <div>
          ...
          <input
            ...
            p-2.5 text-sm text-white placeholder-gray-500 focus:border-emerald-500 
        ...
        <motion.button
          type="button"
          className="flex w-full items-center justify-center rounded-lg bg-black px-5 py-2.5 text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-500"
