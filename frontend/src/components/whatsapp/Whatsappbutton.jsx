 ...
 * WhatsAppButton.jsx
 *
 * A button that immediately opens WhatsApp with a pre-filled message
 * for a single product — no cart needed.
 *
 * Props:
 ...
 *
 * Usage:
 *   <WhatsAppButton product={product} selectedColor="Beige" quantity={2} />
...
export default function WhatsAppButton({
  ...
  const handleClick = () => {
    const line =
      ...
      ` ×${quantity} — KES ${(product.price * quantity).toLocaleString()}`;
